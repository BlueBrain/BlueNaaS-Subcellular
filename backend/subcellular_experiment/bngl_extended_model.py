...
class BnglExtModel:
    ...
    def function_to_str(self, func):
        return "  {}({}) = {}".format(func["name"], func.get("argument", ""), func["definition"])
    ...
    def structure_to_str(self, struct):
        ...
        return "  {} {} {} {}".format(struct["name"], dimensions, struct["size"], parent_name)
    ...
    def diffusion_to_str_as_observable(self, diff):
        return "  Molecules {}{} {}@{}".format(
            DIFF_PREFIX, diff["name"], diff["speciesDefinition"], diff["compartment"]
        )
