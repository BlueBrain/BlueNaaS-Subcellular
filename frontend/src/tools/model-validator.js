...
class ModelValidator {
  constructor(model) {
    this.model = Object.assign({}, model, { valid: true, validationMessages: [] })
    this.allMessages = []
  ...
  validateReaction(reaction) {
    ...
    const allMolDefsHaveStructs = reacMoleculeDefinitions.every((molDef) => getDefStructNames(molDef).length)
  ...
  validate() {
    ...
    this.model.validationMessages = uniqBy(this.allMessages, (message) => `${message.context}: ${message.text}`)
