<template>
  <div class="p-12">
    ...
    <div class="action-block">
      <i-button class="mr-12" type="warning" :disabled="!speciesEdited" @click="resetSpeciesChange">
        Reset
      </i-button>

      <i-button type="primary" :disabled="!speciesEdited" @click="applySpeciesChange">
        Apply
      </i-button>
    </div>
  </div>
