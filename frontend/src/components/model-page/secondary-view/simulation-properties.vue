<template>
  <div class="p-12">
    ...
    <simulation-form class="mt-12" ref="simulationForm" v-model="tmpEntity" @on-submit="applySimulationChange" />

    <div class="action-block">
      <i-button class="mr-12" type="warning" :disabled="!simulationEdited" @click="resetSimulationChange">
        Reset
      </i-button>

      <i-button type="primary" :disabled="!simulationEdited || !tmpEntity.valid" @click="applySimulationChange">
        Apply
      </i-button>
    </div>
  </div>
