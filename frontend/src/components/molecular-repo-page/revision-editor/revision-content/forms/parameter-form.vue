<template>
  <div>
    <i-form ref="form" :model="parameter" :label-width="120">
      <FormItem prop="name" label="Name">
        <i-input ref="nameInput" v-model="parameter.name" @input="onChange" />
      </FormItem>

      <FormItem prop="source" label="Source">
        <i-input disabled :value="parameter.source" @input="onChange" />
      </FormItem>
      ...
      <FormItem prop="comments" label="Comments">
        <i-input type="textarea" autosize v-model="parameter.comments" @input="onChange" />
      </FormItem>
    </i-form>
  </div>
</template>
