...
<template>
  <div>
    ...
    >
      ...
      >
        <i-select
          v-model="molecule.agentType"
          @on-change="onChange"
        >
          <i-option
            v-for="type in agentType"
            :key="type"
            :value="type"
          >
            {{ type }}
