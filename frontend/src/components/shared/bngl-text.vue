  ...
  export default {
    ...
    methods: {
      processTokenMatch(reMatch, tokenType, reGroupIdx, posOffset) {
        ...
        const overlay = this.tokenRanges
          .some(tokenRange => intersection(tokenRange, currentRange).length);
      ...
      getHtml() {
        ...
        const processRuleToken = (tokenType, tokenIdx) => {
          ...
          const offset = reMatch
            .slice(1, tokenIdx + 1)
            .reduce(sumStrLengthReducer, 0);
...
<style lang="scss">
  .bngl-text {
    ...
    .bt-meta { color: #808000; }
    .bt-number { color: #cc5200; }
    .bt-keyword { line-height: 1em; font-weight: bold; color: #000080; }
    .bt-atom { font-weight: bold; color: #2572c4; }
    .bt-def { color: #000000; }
    .bt-variable { color: #0078DE; }
    .bt-variable-2 { color: #964bb4; }
    .bt-variable-3, .bt-type { color: #05ad97; }
    .bt-property { color: black; }
    .bt-operator { color: black; }
    .bt-comment { color: #555555; }
    .bt-string { color: #3d9ca9; }
    .bt-string-2 { color: #008000; }
    .bt-qualifier { color: #555; }
    .bt-error { color: #FF0000; }
    .bt-attribute { color: #0000FF; }
    .bt-tag { color: #000080; }
    .bt-link {
      color: #2a7dcf;
    ...
    .bt-builtin { color: #30a; }
    .bt-bracket { color: #cc7; }
